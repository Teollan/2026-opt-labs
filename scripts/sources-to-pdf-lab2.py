...
output = sys.argv[1] if len(sys.argv) > 1 else str(output_dir / "Козлов КВ-33 ЛАБ2 Додаток 1.pdf")
HTML(string=html).write_pdf(output)
print("Generated sources PDF in docs/lab2/")

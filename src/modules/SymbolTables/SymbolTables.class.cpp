...
size_t SymbolTables::declareKeyword(const std::string& keyword) {
...
size_t SymbolTables::declareIdentifier(const std::string& identifier) {
...
size_t SymbolTables::declareLiteral(const std::string& literal) {
...
SymbolGroup SymbolTables::determineGroup(size_t code) {
...
const std::string& SymbolTables::lookup(size_t code) const {
